...
**Внимание:** в реализации заданий не используется логирование, поэтому в ходе первого сохранения данных в Excel высвечивается предупреждение (хоть и помечается как '`ERROR`'), не обращайте внимание на это сообщение.
...
Смотреть соответственно: `src/main/java/app/NumbersValidator.java`
